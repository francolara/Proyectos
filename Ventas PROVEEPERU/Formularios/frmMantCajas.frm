...
Begin VB.Form frmMantCajas 
   ...
   Begin MSComctlLib.ImageList imgDocVentas 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":039A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":07EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":0B86
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":0F20
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":12BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":1654
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":19EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":1D88
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":2122
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":24BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantCajas.frx":317E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraListado 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin CATControls.CATTextBox txt_TextoBuscar 
            ...
            MaxLength       =   255
            Container       =   "frmMantCajas.frx":3518
            Estilo          =   1
            Vacio           =   -1  'True
            EnterTab        =   -1  'True
         End
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gLista 
         Height          =   3000
         Left            =   90
         OleObjectBlob   =   "frmMantCajas.frx":3534
         TabIndex        =   1
         Top             =   990
         Width           =   7950
      End
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin CATControls.CATTextBox txtCod_Caja 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantCajas.frx":4C3C
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Caja 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantCajas.frx":4C58
         Estilo          =   1
         EnterTab        =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "frmMantCajas"
...
Dim strMsg      As String
    ...
    validaHomonimia "cajas", "GlsCaja", "idCaja", txtGls_Caja.Text, txtCod_Caja.Text, True, StrMsgError
    If StrMsgError <> "" Then GoTo Err
    
    If txtCod_Caja.Text = "" Then 'graba
        txtCod_Caja.Text = GeneraCorrelativoAnoMes("cajas", "idCaja")
        EjecutaSQLForm Me, 0, True, "cajas", StrMsgError
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Grabo"
    
    Else 'modifica
    
        EjecutaSQLForm Me, 1, True, "cajas", StrMsgError, "idCaja"
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Modifico"
    End If
...
Dim StrMsgError As String
    ...
    mostrarCaja gLista.Columns.ColumnByName("idCaja").Value, StrMsgError
    If StrMsgError <> "" Then GoTo Err
...
Private Sub listaCajas(ByRef StrMsgError As String)
On Error GoTo Err
...
Dim rsdatos                     As New ADODB.Recordset
    ...
    If Trim(txt_TextoBuscar.Text) <> "" Then
        ...
        strCond = " AND GlsCaja LIKE '%" & strCond & "%'"
    End If
    
    csql = "SELECT a.idCaja ,a.GlsCaja " & _
           "FROM cajas a WHERE a.idEmpresa = '" & glsEmpresa & "'"
    If strCond <> "" Then csql = csql & strCond

    csql = csql & " ORDER BY a.idCaja"
...
Private Sub mostrarCaja(strCod As String, ByRef StrMsgError As String)
On Error GoTo Err
Dim rst As New ADODB.Recordset

    csql = "SELECT a.idCaja,a.GlsCaja " & _
           "FROM cajas a " & _
           "WHERE a.idCaja = '" & strCod & "' AND a.idEmpresa = '" & glsEmpresa & "'"
...
Dim rsValida As New ADODB.Recordset
    ...
    strCodigo = Trim(txtCod_Caja.Text)
    
    csql = "SELECT idCaja FROM cajasusuario WHERE idCaja = '" & strCodigo & "' AND idEmpresa = '" & glsEmpresa & "'"
    rsValida.Open csql, Cn, adOpenForwardOnly, adLockReadOnly
    If Not rsValida.EOF Then
        StrMsgError = "No se puede eliminar el registro, el registro se encuentra en uso (Cajas por Usuario)"
        GoTo Err
    End If
    
    csql = "SELECT idCaja FROM movcajas WHERE idCaja = '" & strCodigo & "' AND idEmpresa = '" & glsEmpresa & "'"
    If rsValida.State = 1 Then rsValida.Close
    rsValida.Open csql, Cn, adOpenForwardOnly, adLockReadOnly
    If Not rsValida.EOF Then
        StrMsgError = "No se puede eliminar el registro, el registro se encuentra en uso (Movimiento de Cajas)"
        GoTo Err
    End If
    ...
    csql = "DELETE FROM cajas WHERE idCaja = '" & strCodigo & "' AND idEmpresa = '" & glsEmpresa & "'"
    Cn.Execute csql
