...
Begin VB.Form frmMantMarcas 
   ...
   Begin MSComctlLib.ImageList imgDocVentas 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":039A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":07EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":0B86
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":0F20
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":12BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":1654
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":19EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":1D88
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":2122
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":24BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantMarcas.frx":317E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraListado 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin CATControls.CATTextBox txt_TextoBuscar 
            ...
            MaxLength       =   255
            Container       =   "frmMantMarcas.frx":3518
            Estilo          =   1
            Vacio           =   -1  'True
            EnterTab        =   -1  'True
         End
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gLista 
         Height          =   5835
         Left            =   120
         OleObjectBlob   =   "frmMantMarcas.frx":3534
         TabIndex        =   1
         Top             =   960
         Width           =   8175
      End
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin CATControls.CATTextBox txtCod_Marca 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantMarcas.frx":4C46
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Marca 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantMarcas.frx":4C62
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox TxtDctoListaPrec 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantMarcas.frx":4C7E
         Estilo          =   3
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "frmMantMarcas"
...
Dim strMsg      As String, CSqlC As String
    ...
    validaHomonimia "marcas", "GlsMarca", "idMarca", txtGls_Marca.Text, txtCod_Marca.Text, True, StrMsgError
    If StrMsgError <> "" Then GoTo Err
    
    If txtCod_Marca.Text = "" Then
        txtCod_Marca.Text = GeneraCorrelativoAnoMes("marcas", "idMarca")
        EjecutaSQLForm Me, 0, True, "marcas", StrMsgError
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Grabó"
        
    Else
        EjecutaSQLForm Me, 1, True, "marcas", StrMsgError, "idMarca"
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Modificó"
    End If

    If traerCampo("Parametros", "ValParametro", "GlsParametro", "ACTUALIZA_DESCUENTO_NIVEL", True) = "1" Then
        CSqlC = "Update Productos A " & _
                ...
                "Where A.IdEmpresa = '" & glsEmpresa & "' And A.IdMarca = '" & txtCod_Marca.Text & "'"
        Cn.Execute (CSqlC)
    End If
...
Dim StrMsgError As String
    ...
    mostrarMarca gLista.Columns.ColumnByName("idMarca").Value, StrMsgError
    If StrMsgError <> "" Then GoTo Err
...
Dim StrMsgError As String
    ...
    Select Case Button.Index
        ...
        Case 5 'Eliminar
            ...
            If StrMsgError <> "" Then GoTo Err
        Case 6 'Imprimir
            gLista.m.ExportToXLS App.Path & "\Temporales\Mantenimiento_Marcas.xls"
            ShellEx App.Path & "\Temporales\Mantenimiento_Marcas.xls", essSW_MAXIMIZE, , , "open", Me.hwnd
        Case 8 'Salir
            Unload Me
    End Select
...
Dim rsdatos                     As New ADODB.Recordset
    ...
    If Trim(txt_TextoBuscar.Text) <> "" Then
        ...
        strCond = " AND m.GlsMarca LIKE '%" & strCond & "%'"
    End If
    
    csql = "SELECT m.idMarca ,m.GlsMarca " & _
           "FROM marcas m WHERE m.idEmpresa = '" & glsEmpresa & "'"
    If strCond <> "" Then csql = csql + strCond
    csql = csql & " ORDER BY m.idMarca"
...
Dim rst As New ADODB.Recordset
    ...
    csql = "SELECT m.idMarca,m.GlsMarca,m.IdMarca,m.MaxDcto " & _
           "FROM marcas m " & _
           "WHERE m.idMarca = '" & strCodMarca & "' AND m.idEmpresa = '" & glsEmpresa & "'"
