...
Begin VB.Form frmRptVentasporResponsableTDoc 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Ventas por Responsable y Tipo de Documento"
   ClientHeight    =   3000
   ClientLeft      =   7965
   ClientTop       =   2940
   ClientWidth     =   6915
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmbAyudaMoneda 
         Height          =   315
         Left            =   6120
         Picture         =   "frmRptVentasporResponsableTDoc.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   1650
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaSucursal 
         Height          =   315
         Left            =   6120
         Picture         =   "frmRptVentasporResponsableTDoc.frx":038A
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   1290
         Width           =   390
      ...
      Begin CATControls.CATTextBox txtCod_Sucursal 
         ...
         MaxLength       =   8
         Container       =   "frmRptVentasporResponsableTDoc.frx":0714
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Sucursal 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmRptVentasporResponsableTDoc.frx":0730
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_Moneda 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmRptVentasporResponsableTDoc.frx":074C
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Moneda 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmRptVentasporResponsableTDoc.frx":0768
         Vacio           =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "frmRptVentasporResponsableTDoc"
