...
Begin VB.Form frmListaDocExportar 
   ...
   Begin VB.Frame fraListado 
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gListaDetalle 
         Height          =   2535
         Left            =   75
         OleObjectBlob   =   "frmListaDocExportar.frx":DCBD
         TabIndex        =   2
         Top             =   5475
         Width           =   12315
      End
...
Dim StrMsgError As String
    ...
    rsdatos.Open "EXEC Spu_TraeDocImportar '" & strTDExportar & "'", Cn, adOpenStatic, adLockOptimistic
    If Not rsdatos.EOF Then
        txtCod_Documento.Text = Trim("" & rsdatos.Fields("cod"))
    Else
...
Dim F_SoloVta   As String
    ...
    rsg.Fields.Append "IdContacto", adVarChar, 8, adFldIsNullable
    rsg.Fields.Append "ubigeollegada", adVarChar, 8, adFldIsNullable
    ...
    RsD.Fields.Append "IdLote", adVarChar, 30, adFldIsNullable
    ...
    RsD.Fields.Append "GlsProveedor", adVarChar, 150, adFldIsNullable
    RsD.Fields.Append "CostoS", adDouble, 14, adFldIsNullable
    RsD.Fields.Append "CostoD", adDouble, 14, adFldIsNullable
    RsD.Fields.Append "Margen", adInteger, 14, adFldIsNullable
    RsD.Fields.Append "CostoSInc", adDouble, 14, adFldIsNullable
    ...
    If traerCampo("Documentos", "Aprobacion", "iddocumento", txtCod_Documento.Text, False) = "S" Then
        strFiltroAprob = "" 'strFiltroAprob = " AND indAprobado = '1' "
    Else
        strFiltroAprob = ""
    End If
    
    F_SoloVta = ""
    If Trim("" & txtCod_Documento.Text) = "86" Then
        F_SoloVta = " AND idMotivoTraslado = '06090001'"
    End If
'
...
'                "A.GlsVehiculo,A.Placa,A.Marca,A.Color,A.Modelo,A.CodInsCrip,A.Brevete,A.RucEmpTrans,A.IdCentroCosto,A.IdLista,A.IdAlmacen,A.IdContacto,A.ubigeollegada " & _
'                "From Docventas A " & _
...
'                "And A.EstDocImportado <> 'S' And (C.IndGenerado = 'M' Or (B.IndCierre = '1' And B.EstValeConver <> 'ANU'))" & strFiltroAprob & F_SoloVta
'
...
'                "A.GlsVendedor,A.FecEmision,A.EstDocVentas,A.IdMoneda,A.TotalValorVenta,A.TotalIGVVenta,A.TotalPrecioVenta,A.NumOrdenCompra," & _
'                "A.Llegada,A.IdMoneda,A.FecIniTraslado,A.TipoCambio,A.IdPerChofer,A.GlsChofer,A.IdPerEmpTrans,A.GlsEmpTrans,A.IdVehiculo," & _
'                "A.GlsVehiculo,A.Placa,A.Marca,A.Color,A.Modelo,A.CodInsCrip,A.Brevete,A.RucEmpTrans,A.IdCentroCosto,A.IdLista,A.TotalPrecioVenta TotalPrecioVentaOri,A.IdAlmacen,A.IdContacto,A.ubigeollegada " & _
'                "From DocVentas A " & _
...
'    End If
    ...
    If Not rst.EOF And Not rst.BOF Then
        Do While Not rst.EOF
            ...
            rsg.Fields("IdContacto") = Trim("" & rst.Fields("IdContacto"))
            rsg.Fields("ubigeollegada") = Trim("" & rst.Fields("ubigeollegada"))
            rsg.Fields("obsdocventas") = Trim("" & rst.Fields("obsdocventas"))
            rst.MoveNext
        Loop
...
'                    "A.TotalPVBruto TotalPVBrutoOri,A.IvapUnit,A.TotalIvapNeto,A.GlsProveedor,A.CostoS,A.CostoD,A.Margen,A.CostoSInc " & _
...
'        End If
        ...
        Do While Not rst.EOF
            ...
            RsD.Fields("GlsProveedor") = ("" & rst.Fields("GlsProveedor"))
            RsD.Fields("CostoS") = Val("" & rst.Fields("CostoS"))
            RsD.Fields("CostoD") = Val("" & rst.Fields("CostoD"))
            RsD.Fields("Margen") = Val("" & rst.Fields("Margen"))
            RsD.Fields("CostoSInc") = Val("" & rst.Fields("CostoSInc"))
...
On Error GoTo Err
    ...
    XstrCodCliente = strCodCliente
    txtCod_Cliente.Text = strCodCliente
    'txtCod_Documento.Text = ""
   
    dtp_Desde.Value = getFechaSistema
    dtp_Hasta.Value = dtp_Desde.Value
    dtp_Desde.Value = DateAdd("m", -1, dtp_Desde.Value)
    'dtp_Hasta.Value = DateAdd("m", -1, dtp_Desde.Value)
    indNuevoDoc = False
