...
Begin VB.Form frmRankingVentas 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmbAyudaMoneda 
         ...
         Height          =   315
         Left            =   6385
         Picture         =   "frmRankingVentas.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   1780
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaSucursal 
         ...
         Height          =   315
         Left            =   6385
         Picture         =   "frmRankingVentas.frx":038A
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   1410
         Width           =   390
      ...
      Begin CATControls.CATTextBox txtCod_Sucursal 
         ...
         MaxLength       =   8
         Container       =   "frmRankingVentas.frx":0714
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Sucursal 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmRankingVentas.frx":0730
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_Moneda 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmRankingVentas.frx":074C
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Moneda 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmRankingVentas.frx":0768
         Vacio           =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "frmRankingVentas"
...
Dim CIndMuestras        As String
    ...
    If optTipo(0).Value Then
        frmRankingVentasConsulta.MostrarDatos Format(dtpfInicio.Value, "yyyy-mm-dd"), Format(dtpFFinal.Value, "yyyy-mm-dd"), txtCod_Moneda.Text, optTipo(0).Value, txtCod_Sucursal.Text, ChkOficial.Value, StrMsgError, COrden, CIndMuestras
    Else
        frmRankingVentasxProductoConsulta.MostrarDatos Format(dtpfInicio.Value, "yyyy-mm-dd"), Format(dtpFFinal.Value, "yyyy-mm-dd"), txtCod_Moneda.Text, optTipo(0).Value, txtCod_Sucursal.Text, ChkOficial.Value, StrMsgError, COrden, CIndMuestras
    End If
...
Private Sub opttipo_Click(Index As Integer)
    ...
    OptOrden(0).Caption = optTipo(Index).Caption
