...
Begin VB.Form FrmKardexPorLote 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton CmbAyudaAlmacen 
         ...
         Height          =   315
         Left            =   6600
         Picture         =   "FrmKardexPorLote.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   810
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaMoneda 
         ...
         Height          =   315
         Left            =   6600
         Picture         =   "FrmKardexPorLote.frx":038A
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   2565
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaProducto 
         ...
         Height          =   315
         Left            =   6600
         Picture         =   "FrmKardexPorLote.frx":0714
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   2205
         Width           =   390
      End
      Begin VB.CommandButton CmbAyudaLote 
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Height          =   315
         Left            =   6600
         Picture         =   "FrmKardexPorLote.frx":0A9E
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   370
         Width           =   390
      ...
      Begin VB.Frame fraReportes 
         ...
         End
      End
      Begin CATControls.CATTextBox TxtCodLote 
         Height          =   315
         Left            =   1230
         TabIndex        =   0
         Tag             =   "TidAlmacen"
         ...
         MaxLength       =   8
         Container       =   "FrmKardexPorLote.frx":0E28
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox TxtGlsLote 
         Height          =   315
         Left            =   2205
         TabIndex        =   14
         Top             =   375
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmKardexPorLote.frx":0E44
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_Producto 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmKardexPorLote.frx":0E60
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Producto 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmKardexPorLote.frx":0E7C
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_Moneda 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "FrmKardexPorLote.frx":0E98
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Moneda 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmKardexPorLote.frx":0EB4
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox TxtCod_Almacen 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "FrmKardexPorLote.frx":0ED0
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox TxtGls_Almacen 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmKardexPorLote.frx":0EEC
         Vacio           =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "FrmKardexPorLote"
...
Private Sub CmbAyudaLote_Click()
    
    mostrarAyuda "LOTES", TxtCodLote, TxtGlsLote
    If TxtCodLote.Text <> "" Then SendKeys "{tab}"
...
Dim CIdProducto     As String
    ...
    If Opt1.Value = True Then
        Set reporte = aplicacion.OpenReport(gStrRutaRpts & "rptKardexPorLote.rpt")
    ElseIf Opt2.Value = True Then
        Set reporte = aplicacion.OpenReport(gStrRutaRpts & "rptKardexPorLote" & Format(glsNumNiveles, "00") & ".rpt")
    End If
...
Dim RsTempAntClone              As ADODB.Recordset
    ...
    If Opt1.Value = True Then
        ...
        strSQL = "SELECT IIf(Len(Trim(IsNull(VD.IdLote,''))) = 0 And VD.IdSucursal = '08090001','10120001'," & _
                    "IIf(VD.IdSucursal = '08090002','10120002',VD.IdLote)) IdLote,L.GlsLote,vc.idValesCab,vc.idConcepto,vc.IdSucursal, " & _
                    "vc.tipoVale," & _
                    ...
                    "END as VVUnit,(Vc.IdAlmacen + ' ' + A.GlsAlmacen) As Almacen,Z.GlsConcepto,pr.IdTallaPeso "
        ...
        strSQL = strSQL & "Left Join tiposdecambio t " & _
                        "On CAST(vc.fechaEmision AS DATE) = CAST(t.fecha AS DATE) " & _
                    "Inner Join Lotes L " & _
                        "On Vd.IdEmpresa = L.IdEmpresa And Vd.IdSucursal = L.IdSucursal And IIf(Len(Trim(IsNull(VD.IdLote,''))) = 0 And VD.IdSucursal = '08090001','10120001'," & _
                    "IIf(VD.IdSucursal = '08090002','10120002',VD.IdLote)) = L.IdLote "
        strSQL = strSQL & "WHERE vc.idEmpresa = '" & glsEmpresa & "' And L.Estado = 'ACT' AND pr.idEmpresa = '" & glsEmpresa & "' " & _
                    IIf(Len(Trim(TxtCodLote.Text)) = 0, "", "AND vd.IdLote = '" & TxtCodLote.Text & "' ") & _
    ...
    Else
        ...
        strSQL = "SELECT " & cNiveles & " vc.idValesCab,vc.IdSucursal," & _
                    "Iif(Len(Trim(IsNull(VD.IdLote,''))) = 0 And VD.IdSucursal = '08090001','10120001'," & _
                    "Iif(VD.IdSucursal = '08090002','10120002',VD.IdLote)) IdLote,L.GlsLote,vc.tipoVale," & _
                    "vc.fechaEmision,iif('" & visCodRapido & "' = 'S',pr.Codigorapido,vd.IdProducto) xIdProducto, " & _
                    "pr.IdProducto," & _
                    "pr.GlsProducto," & _
                    "vc.IdAlmacen," & _
    ...
    End If
    strSQL = strSQL & " ORDER BY Iif(Len(Trim(ISNull(VD.IdLote,''))) = 0 And VD.IdSucursal = '08090001','10120001'," & _
                    "Iif(VD.IdSucursal = '08090002','10120002',VD.IdLote)), vd.IdProducto,vc.FechaEmision,vc.tipovale,vc.idvalescab"
    ...
    RsD.Fields.Append "IdLote", adVarChar, 10, adFldIsNullable
    RsD.Fields.Append "GlsLote", adVarChar, 200, adFldIsNullable
    ...
    rstempAnt.Open "exec Spu_ListaSaldoInicialProductosPorLote '" & glsEmpresa & "','" & txtCod_Almacen.Text & "','" & codproducto & "','" & txtCod_Moneda.Text & "','" & Format(dtpfInicio.Value, "yyyy-mm-dd") & "','" & Format(dtpFFinal.Value, "yyyy-mm-dd") & "','" & txtCod_Almacen.Text & "'", Cn, adOpenStatic, adLockReadOnly
    ...
    Do While Not rstempAnt.EOF
        ...
        i = 0
        RsD.Fields("Item") = i
        RsD.Fields("IdLote") = "" & rstempAnt.Fields("IdLote")
        RsD.Fields("GlsLote") = "" & rstempAnt.Fields("GlsLote")
    ...
    Do While Not rstemp.EOF
        If StrCodalmacenx = "" Then
            StrCodalmacenx = Trim("" & rstemp.Fields("IdLote"))
        End If
        
        If StrCodalmacenx <> Trim("" & rstemp.Fields("IdLote")) Then
            StrCodalmacenx = Trim("" & rstemp.Fields("IdLote"))
            dblSaldo = 0
            dblValSaldo = 0
        End If
        ...
        If (CodProd <> rstemp.Fields("IdProducto") And Codalmax <> Trim("" & rstemp.Fields("IdLote"))) Or (CodProd = rstemp.Fields("IdProducto") And Codalmax <> Trim("" & rstemp.Fields("IdLote"))) Or (CodProd <> rstemp.Fields("IdProducto") And Codalmax = Trim("" & rstemp.Fields("IdLote"))) Then
                        
            RsTempAntClone.Filter = "IdLote = '" & Trim("" & rstemp.Fields("IdLote")) & "' And IdProducto = '" & Trim("" & rstemp.Fields("IdProducto")) & "'"
            ...
            Else
                ...
                i = 0
                RsD.Fields("Item") = i
                RsD.Fields("IdLote") = "" & rstemp.Fields("IdLote")
                RsD.Fields("GlsLote") = "" & rstemp.Fields("GlsLote")
                RsD.Fields("idValesCab") = "I"
                RsD.Fields("fechaEmision") = ""
...
Private Sub TxtCodLote_Change()
On Error GoTo Err
Dim StrMsgError                         As String
    
    TxtGlsLote.Text = traerCampo("Lotes", "GlsLote", "IdLote", TxtCodLote.Text, True, "Estado = 'ACT'")
