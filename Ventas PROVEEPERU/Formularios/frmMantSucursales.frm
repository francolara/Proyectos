...
Begin VB.Form frmMantSucursales 
   Appearance      =   0  'Flat
   ...
   Begin MSComctlLib.ImageList imgDocVentas 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":039A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":07EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":0B86
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":0F20
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":12BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":1654
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":19EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":1D88
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":2122
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":24BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantSucursales.frx":317E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraListado 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin CATControls.CATTextBox txt_TextoBuscar 
            ...
            MaxLength       =   255
            Container       =   "frmMantSucursales.frx":3518
            Estilo          =   1
            Vacio           =   -1  'True
            EnterTab        =   -1  'True
         End
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gLista 
         Height          =   3705
         Left            =   120
         OleObjectBlob   =   "frmMantSucursales.frx":3534
         TabIndex        =   1
         Top             =   1005
         Width           =   8085
      End
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.CommandButton cmbAyudaCliente 
         Height          =   315
         Left            =   7560
         Picture         =   "frmMantSucursales.frx":4C60
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   1060
         Width           =   390
      ...
      Begin CATControls.CATTextBox txtCod_Cliente 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantSucursales.frx":4FEA
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Cliente 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantSucursales.frx":5006
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtGlsAbrev 
         Height          =   315
         Left            =   1305
         TabIndex        =   3
         Tag             =   "TGlsAbrev"
         ...
         ForeColor       =   -2147483640
         MaxLength       =   10
         Container       =   "frmMantSucursales.frx":5022
         Estilo          =   1
         EnterTab        =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "frmMantSucursales"
...
Private Sub cmbAyudaCliente_Click()
    ...
    mostrarAyuda "PERSONASUCURSAL", txtCod_Cliente, txtGls_Cliente
...
Dim strMsg      As String
    ...
    If indBoton = 0 Then 'graba
        EjecutaSQLForm Me, 0, True, "sucursales", StrMsgError
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Grabo"
    
    Else 'modifica
        EjecutaSQLForm Me, 1, True, "sucursales", StrMsgError, "idSucursal"
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Modifico"
    End If
...
Dim StrMsgError As String
    ...
    mostrarSucursal gLista.Columns.ColumnByName("idSucursal").Value, StrMsgError
    If StrMsgError <> "" Then GoTo Err
...
Dim StrMsgError As String
    ...
    Select Case Button.Index
        ...
        Case 5 'Eliminar
            ...
            If StrMsgError <> "" Then GoTo Err
        Case 6 'Imprimir
            gLista.m.ExportToXLS App.Path & "\Temporales\Mantenimiento_Sucursales.xls"
            ShellEx App.Path & "\Temporales\Mantenimiento_Sucursales.xls", essSW_MAXIMIZE, , , "open", Me.hwnd
        Case 8 'Salir
            Unload Me
    End Select
...
Private Sub listaSucursal(ByRef StrMsgError As String)
On Error GoTo Err
...
Dim rsdatos                     As New ADODB.Recordset
    ...
    If Trim(txt_TextoBuscar.Text) <> "" Then
        ...
        strCond = " AND p.GlsPersona LIKE '%" & strCond & "%'"
    End If
    
    csql = "SELECT s.idSucursal ,p.GlsPersona " & _
           "FROM sucursales s,personas p " & _
           "WHERE s.idSucursal = p.IdPersona AND idEmpresa = '" & glsEmpresa & "'"
           
    If strCond <> "" Then csql = csql & strCond
    csql = csql & " ORDER BY s.idSucursal"
...
Private Sub mostrarSucursal(strCodSucursal As String, ByRef StrMsgError As String)
On Error GoTo Err
Dim rst As New ADODB.Recordset

    csql = "SELECT s.idSucursal ,s.GlsAbrev " & _
           "FROM sucursales s " & _
           "WHERE s.idSucursal = '" & strCodSucursal & "'"
...
Private Sub txtCod_Cliente_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii <> 13 Then
        mostrarAyudaKeyascii KeyAscii, "PERSONASUCURSAL", txtCod_Cliente, txtGls_Cliente
        KeyAscii = 0
        If txtCod_Cliente.Text <> "" Then SendKeys "{tab}"
    End If
...
Dim rsValida As New ADODB.Recordset
    ...
    strCodigo = Trim(txtCod_Cliente.Text)
    
    '--- Validando
    csql = "SELECT idSucursal FROM docventas WHERE idSucursal = '" & strCodigo & "' AND idEmpresa = '" & glsEmpresa & "'"
    ...
    csql = "DELETE FROM sucursales WHERE idSucursal = '" & strCodigo & "' AND idEmpresa = '" & glsEmpresa & "'"
    Cn.Execute csql
