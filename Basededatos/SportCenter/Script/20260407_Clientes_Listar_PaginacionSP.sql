...
Descripcion: Agrega paginacion, total de registros, filtro de busqueda y KPIs globales en Sp_Clientes_Listar para que el listado de clientes consulte por pagina desde SQL Server.
*/
USE [DbSportCenter]
GO
SET ANSI_NULLS ON
