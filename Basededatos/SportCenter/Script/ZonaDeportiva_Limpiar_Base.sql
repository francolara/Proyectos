...
BEGIN TRY
    ...
    DELETE FROM dbo.BoletinesDeportivos;
    DELETE FROM dbo.NegociosSuscripcionPago;
    DELETE FROM dbo.NegociosSuscripcionMovimiento;
    ...
    DELETE FROM dbo.EspaciosDeportivosCompartidos;

    DELETE FROM dbo.EspacioHorarioAtencion;
    ...
    VALUES
        ...
        (N'NegociosSuscripcionPago'),
        (N'NegociosSuscripcionMovimiento'),
    ...
    DECLARE CurReseed CURSOR LOCAL FAST_FORWARD FOR
        ...
        INNER JOIN sys.identity_columns AS IC
            ON IC.object_id = OBJECT_ID(QUOTENAME(N'dbo') + N'.' + QUOTENAME(TR.TableName))
