...
Descripcion: Agrega FechaPago y NumeroOperacion (alfanumerico opcional) en creacion/edicion de reservas para registro de pago en modal; y en edicion auto-ajusta estado a Pagada cuando el pago acumulado llega al 100%.
*/
