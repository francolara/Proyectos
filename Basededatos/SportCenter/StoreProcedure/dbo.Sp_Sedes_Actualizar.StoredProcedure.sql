USE [DbSportCenter]
GO
/****** Object:  StoredProcedure [dbo].[Sp_Sedes_Actualizar]    Script Date: 3/04/2026 23:18:34 ******/
SET ANSI_NULLS ON
GO
...
-- Description:   Agrega parametro y actualizacion de ConsideracionesReserva en sedes.
-- =============================================
-- =============================================
-- Author:        FRANCO LARA
...
BEGIN
    ...
    BEGIN TRY
        ...
        SET Nombre = @Nombre,
            ...
            InstagramUrl = NULLIF(LTRIM(RTRIM(@InstagramUrl)), N''),
            TwitterUrl = NULLIF(LTRIM(RTRIM(@TwitterUrl)), N''),
            Activo = @Activo,
            Latitud = @Latitud,
            Longitud = @Longitud,
