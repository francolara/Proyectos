...
-- Description:   Elimina la generacion de ajuste de cuentas de un periodo.
-- =============================================
-- Firma: FRANCO LARA - 02/07/2026 | Elimina solo la generacion automatica AJU del periodo, removiendo proceso, detalle, asientos asociados y correlativo sobrante.

CREATE OR ALTER PROCEDURE dbo.usp_CON_EliminarAjusteCuentaProceso
    @IdEmpresa INT,
    @Periodo CHAR(6),
