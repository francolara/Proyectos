...
{
    public class DaoDocFacturacion : DaoB
    {
        ...
        public Dto_GuiaRemision Envia_DocFac_Det_GR(DtoB dtoBase)
        {
            Dto_GuiaRemision_Param dto = (Dto_GuiaRemision_Param)dtoBase;
            Dto_GuiaRemision cr = new Dto_GuiaRemision();
        ...
        public Dto_GuiaRemision Envia_DocFac_Det(DtoB dtoBase)
        {
            Dto_GuiaRemision_Param dto = (Dto_GuiaRemision_Param)dtoBase;
            Dto_GuiaRemision cr = new Dto_GuiaRemision();
            SqlParameter[] pr = new SqlParameter[5];
        ...
        public Dto_GuiaRemision Consulta_Estado_DocFac(DtoRespuestaPSE_OSE_NUBEFACT _dtoRES)
        {
            ...
            try
            {
                ...
                if (dto.C_CAMPO_RESPUESTA_14 == "PEN")
                {
                    return cr;
                }
