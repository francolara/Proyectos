...
public sealed class ProcesoAperturaViewModel
{
    public int IdEmpresa { get; set; }
    public string EmpresaNombre { get; set; } = string.Empty;
    public short AnioAperturaSeleccionado { get; set; }
    public short AnioSaldo { get; set; }
    ...
    public List<AperturaProcesoDetalleItemViewModel> Detalles { get; set; } = [];
}
