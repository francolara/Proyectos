...
public sealed class DiferenciaCambioProcesoDetalleDto
{
    public int IdDiferenciaCambioProcesoDetalle { get; init; }
    public int IdDiferenciaCambioProceso { get; init; }
    ...
    public bool GeneraPorAnalisis { get; init; }
