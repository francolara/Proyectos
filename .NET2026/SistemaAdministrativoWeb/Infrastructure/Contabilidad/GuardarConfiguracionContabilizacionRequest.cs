...
public sealed class GuardarConfiguracionContabilizacionRequest
{
    ...
    public IReadOnlyCollection<GuardarConfiguracionContabilizacionDetalleRequest> Detalles { get; init; } = [];
}
