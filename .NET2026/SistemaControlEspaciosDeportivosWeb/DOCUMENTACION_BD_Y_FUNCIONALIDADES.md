...
### Cambios funcionales
- Se agrega m�dulo `Cupones` en panel de administraci�n de negocio con listado paginado de 20 registros por p�gina.
- Se permite crear cupones por negocio, con restricci�n opcional por sede y espacio deportivo.
- Se define l�mite m�ximo de usos por cup�n y acumulaci�n de usos en cada aplicaci�n.
...
- El uso exitoso de cup�n incrementa contador y se registra en `CuponesUso`.
- `Sp_Home_SolicitarReservaPublica` ahora recibe y reenv�a `@CodigoCupon` al crear la reserva p�blica.
- La tabla `Reservas` incorpora trazabilidad de cup�n aplicado y descuento (`CodigoCuponAplicado`, `DescuentoCupon`).
...
- Actualizacion 25/05/2026 (checklist onboarding):
  - Sp_OnboardingChecklist_Validar ampl�a Configuraci�n inicial obligatoria a: RazonSocial, TipoDocumentoFiscal, NumeroDocumentoFiscal, DireccionFiscal, CodigoDepartamento, CodigoProvincia, CodigoUbigeo, PorcentajeIgv, CancelacionAutomaticaNoConfirmada, PermitirModificarPrecioReserva (adem�s de NombreComercial, MonedaId).
