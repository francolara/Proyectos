CREATE OR ALTER PROCEDURE dbo.spu_ListaInventarioValorizado
    @varEmpresa CHAR(2),
    @varSucursal CHAR(8),
...
BEGIN
	...
	SELECT x.idEmpresa,x.idNivel01, x.GlsNivel01,x.idNivel02, x.GlsNivel02,
		...
		SELECT vn.idEmpresa,vn.idNivel01, vn.GlsNivel01,vn.idNivel02, vn.GlsNivel02, 		   
		   ...
		   --IIF(ROUND((IIF((vc.tipoVale = 'I'), vd.Cantidad, (vd.Cantidad * -1))), 2) > 0, 
			  --      (((IIF((vc.tipoVale = 'I'), vd.Cantidad, (vd.Cantidad * -1))) * 
					...
					--   END) / 
				 --   (IIF((vc.tipoVale = 'I'), vd.Cantidad, (vd.Cantidad * -1)))), 0) AS Costo,
	...
	GROUP BY x.idEmpresa,x.idNivel01, x.GlsNivel01,x.idNivel02, x.GlsNivel02,x.idProducto, x.GlsProducto, x.abreUM,x.IdFabricante, x.GlsMarca
