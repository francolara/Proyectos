...
On Error GoTo Err
    ...
    csql = "SELECT item, idProducto, CAST(GlsProducto AS VARCHAR (500)) AS GlsProducto, GlsMarca, GlsUM, CAST(Cantidad AS DECIMAL(10,2)) AS Cantidad, CAST(PVUnit AS DECIMAL(10,2)) AS PVUnit, CAST(PorDcto AS DECIMAL(10,2)) AS PorDcto, CAST(TotalPVNeto AS DECIMAL(10,2)) AS TotalPVNeto " & _
           "FROM docventasdet " & _
...
Dim strSP As String
    ...
    If strParamImpOC = "1" Then
     ...
     ElseIf strParamImpOC = "3" Then
         If strTipoDoc = "94" Then
              strReporte = "rptImpOCompra_Apimas.rpt"
              strTitulo = "Orden de Compra"
         ElseIf strTipoDoc = "87" Then
             strReporte = "rptImpRCompra.rpt"
             strTitulo = "Requerimiento de Compra"
