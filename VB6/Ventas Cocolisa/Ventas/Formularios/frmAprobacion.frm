...
Begin VB.Form frmAprobacion 
   ...
   Caption         =   "Acceso a la Anulación de Documentos"
   ClientHeight    =   2655
   ClientLeft      =   6465
   ClientTop       =   2430
   ClientWidth     =   4395
   ...
   Begin VB.PictureBox SSFrame1 
      ...
      Begin CATControls.CATTextBox txtusuario 
         ...
         Container       =   "frmAprobacion.frx":0000
      End
      Begin CATControls.CATTextBox txtpassword 
         ...
         ForeColor       =   -2147483640
         PasswordChar    =   "*"
         Container       =   "frmAprobacion.frx":001C
      End
...
Dim StrMsgError As String
    ...
    Select Case Index
        Case 0
            ...
            'Verifica Password
            contraseña = numero()
            If Val(txtpassword.Value) <> contraseña Then
                If intento = 3 Then
                    MsgBox "Demasiados numeros de intentos", vbInformation, App.Title
                    Unload Me
                    Exit Sub
        ...
        Case 1
            ...
            Unload Me
    End Select
    If rstAprob.State = 1 Then rstAprob.Close: Set rstAprob = Nothing
