    ...
    Select Case Column.Index
        Case gPagos.Columns.ColumnByFieldName("idFormadePago").Index
            ...
            If Trim("" & traerCampo("parametros", "valparametro", "GLSPARAMETRO", "FORMA_PAGOS_X_CLIENTE", True)) = "S" Then
                ...
                'StrCod = StrFPagoval
                strCod = txtCod_FormaPago.Text
                StrDes = Trim("" & traerCampo("formaspagos", "GlsFormapago", "idformapago", Trim("" & strCod), True))
...
Dim strCodMovCaja   As String
    ...
    If Trim("" & traerCampo("parametros", "valparametro", "GLSPARAMETRO", "FORMA_PAGOS_X_CLIENTE", True)) = "S" Then
        ...
        StrFPagoval = Trim("" & traerCampo("docventas", "idformapago", "iddocventas", Trim("" & strNumDoc), True, " idserie = '" & Trim("" & strSerie) & "' and iddocumento = '" & Trim("" & strTD) & "' "))
        
        strCod = StrFPagoval
        StrDes = Trim("" & traerCampo("formaspagos", "GlsFormapago", "idformapago", Trim("" & strCod), True))
        
        
        If Trim("" & StrFPagoval) = "" Then
