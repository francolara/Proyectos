...
DROP PROCEDURE IF EXISTS `spu_ResumenVentas` $$
CREATE  PROCEDURE `spu_ResumenVentas`(
varEmpresa   CHAR(2),
varTipo      CHAR(1),
varAno       INTEGER,
varMesDesde  INTEGER,
...
SELECT  varGlsEmpresa AS GlsEmpresa , varGlsRuc AS GlsRuc,FecEmision,GlsCliente,
idDocumento,idSerie,idDocVentas,idPerCliente,idproducto,glsproducto,RUCCliente,
...
FROM
(SELECT
d.idSerie,d.idDocumento,d.idDocVentas,o.GlsDocumento,d.FecEmision,
d.idPerCliente,d.GlsCliente,dt.idproducto,dt.glsproducto,d.RUCCliente,
...
inner join docventasdet dt
  on d.idempresa = dt.idempresa And d.IdSucursal = dt.IdSucursal And d.iddocumento = dt.iddocumento and d.idserie = dt.idserie and d.iddocventas = dt.iddocventas
