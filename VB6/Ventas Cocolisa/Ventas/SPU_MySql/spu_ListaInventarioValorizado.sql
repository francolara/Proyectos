...
DROP PROCEDURE IF EXISTS `spu_ListaInventarioValorizado` $$
CREATE PROCEDURE `spu_ListaInventarioValorizado`(
varEmpresa CHAR(2),
varSucursal CHAR(8),
...
' ''',varGlsSistema,''' AS varGlsSistema,P.IdFabricante,M.GlsMarca ',
'FROM valescab vc ',
...
varNiveles, '',
'GROUP BY vd.idProducto,p.GlsProducto,u.abreUM ',
VarStock,
'Order By ',VarOrdena,'');
