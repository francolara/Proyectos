...
Begin VB.Form FrmBusquedaClientes 
   ...
   Begin VB.CommandButton Cmdbusq 
      DownPicture     =   "FrmBusquedaClientes.frx":29F6
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Height          =   360
      Left            =   10350
      Picture         =   "FrmBusquedaClientes.frx":2DA1
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   225
      Visible         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid g 
         Height          =   4125
         Left            =   75
         OleObjectBlob   =   "FrmBusquedaClientes.frx":314C
         TabIndex        =   1
         Top             =   150
         Width           =   10500
      End
...
If Trim(TxtBusq.Text) <> "" Then
    ...
    "OR " & cadBusqueda & " like '%" & Trim(TxtBusq.Text) & "%' OR P.GlsNombreComercial like '%" & Trim(TxtBusq.Text) & "%' " & SqlAdic & " order by 1"
...
csql = "SELECT item,GlsNombre,GlsDireccion,GlsTelefonos,idtdacli,idDistrito " & _
...
Private Sub devolverResultado(ByVal indVarCabecera As Boolean)
   ...
   Else
    ...
    SRptBus(5) = gTiendas.Columns.ColumnByFieldName("idDistrito").Value
   End If
