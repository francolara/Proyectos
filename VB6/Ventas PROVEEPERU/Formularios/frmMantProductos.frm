   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Begin VB.Frame fraDatos 
            ...
            Top             =   525
            Width           =   9885
            Begin VB.CheckBox ChkDatosDefecto 
               Appearance      =   0  'Flat
               Caption         =   "Cargar Datos por Defecto"
               BeginProperty Font 
                  Name            =   "Arial"
                  Size            =   8.25
                  Charset         =   0
...
Private Sub ChkDatosDefecto_Click()
Dim strCod As String
Dim strDes As String
Dim strCodAlm As String
Dim strDesAlm As String

    If ChkDatosDefecto.Value = 1 Then
    
        txtCod_TipoProd.Text = "06001"
        txtCod_Marca.Text = "23060001"
        txtCod_Moneda.Text = "PEN"
        txtCod_UMCompra.Text = "11050003"
        txtCod_UMVenta.Text = "11050003"
        chkAfecto.Value = 1
        
        strCod = glsSucursal
        strDes = traerCampo("sucursales", "GlsAbrev", "idSucursal", strCod, True)
        strCodAlm = glsAlmVentas
        strDesAlm = traerCampo("almacenes", "glsAlmacen", "idAlmacen", strCodAlm, True)
        ...
        gAlmacenes.Columns.ColumnByFieldName("idAlmacen").Value = strCodAlm
        gAlmacenes.Columns.ColumnByFieldName("GlsAlmacen").Value = strDesAlm
...
Dim xCodigoRapido   As String
    ...
    txtGls_Producto.Text = Replace(txtGls_Producto.Text, "'", "")
    txtGls_Producto.Text = UCase(txtGls_Producto.Text)
    
    validaFormSQL Me, StrMsgError
    If StrMsgError <> "" Then GoTo Err
    
    If OptInactivo.Value = False Then 'graba
...
Dim strRuta As String
    ...
    If Dir(gbRutaProductos, vbDirectory) = "" Then
        MsgBox "La carpeta no existe. " & gbRutaProductos, vbInformation, App.Title
    End If

    If Dir(strRuta) = "" Then
        MsgBox "El archivo no existe. " & strRuta, vbInformation, App.Title
    End If
