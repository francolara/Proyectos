...
Dim StrMsgError As String
    ...
    Select Case Button.Index
        ...
        Case 5 'Eliminar
            ...
            If StrMsgError <> "" Then GoTo Err
        Case 6 'Imprimir
            gLista.m.ExportToXLS App.Path & "\Temporales\Mantenimiento_conceptos.xls"
            ShellEx App.Path & "\Temporales\Mantenimiento_conceptos.xls", essSW_MAXIMIZE, , , "open", Me.hwnd
    '    Case 7 'Lista
    '        fraListado.Visible = True
    '        fraGeneral.Visible = False
        Case 8 'Salir
