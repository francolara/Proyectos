...
Begin VB.Form FrmRptPorCentroCosto 
   Appearance      =   0  'Flat
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmbAyudaCliente 
         Height          =   315
         Left            =   6840
         Picture         =   "FrmRptPorCentroCosto.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   2610
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaMoneda 
         ...
         Height          =   315
         Left            =   6830
         Picture         =   "FrmRptPorCentroCosto.frx":038A
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   2200
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaCentroCosto 
         ...
         Height          =   315
         Left            =   6830
         Picture         =   "FrmRptPorCentroCosto.frx":0714
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   1800
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaSucursal 
         ...
         Height          =   315
         Left            =   6830
         Picture         =   "FrmRptPorCentroCosto.frx":0A9E
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   1395
         Width           =   390
      ...
      Begin CATControls.CATTextBox txtCod_Sucursal 
         ...
         MaxLength       =   8
         Container       =   "FrmRptPorCentroCosto.frx":0E28
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Sucursal 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmRptPorCentroCosto.frx":0E44
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_CentroCosto 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmRptPorCentroCosto.frx":0E60
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_CentroCosto 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "FrmRptPorCentroCosto.frx":0E7C
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_Moneda 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "FrmRptPorCentroCosto.frx":0E98
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Moneda 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmRptPorCentroCosto.frx":0EB4
         Vacio           =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_Cliente 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "FrmRptPorCentroCosto.frx":0ED0
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Cliente 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "FrmRptPorCentroCosto.frx":0EEC
         Vacio           =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "FrmRptPorCentroCosto"
...
Dim GlsForm         As String
    ...
    If leeParametro("AYUDA_CENTRO_COSTO_DETALLE") = "S" Then
        ...
        If OptDetallado.Value Then
            CGlsReporte = "rptVentasPorCcDetalladoEnDetalle.rpt"
            GlsForm = "Reporte por Centro de Costo Detallado"
        Else
            CGlsReporte = "rptVentasPorCcResumidoEnDetalle.rpt"
            GlsForm = "Reporte por Centro de Costo Resumido"
        End If
        
    Else
    
        If OptDetallado.Value Then
            CGlsReporte = "rptVentasPorCcDetallado.rpt"
            GlsForm = "Reporte por Centro de Costo Detallado"
        Else
            CGlsReporte = "rptVentasPorCcResumido.rpt"
            GlsForm = "Reporte por Centro de Costo Resumido"
        End If
    
    End If
    
    mostrarReporte CGlsReporte, "parEmpresa|parSucursal|parFecDesde|parFecHasta|parCcosto|parMoneda|parCliente", glsEmpresa & "|" & Trim("" & txtCod_Sucursal.Text) & "|" & fIni & "|" & Ffin & "|" & Trim(txtCod_CentroCosto.Text) & "|" & Trim(txtCod_Moneda.Text) & "|" & txtCod_Cliente.Text, GlsForm, StrMsgError
...
Private Sub Form_Load()
    ...
    txtGls_CentroCosto.Text = "TODOS LOS CENTROS DE COSTOS"
