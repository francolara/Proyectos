...
Begin VB.Form frmMantUM 
   ...
   Begin MSComctlLib.ImageList imgDocVentas 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":039A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":07EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":0B86
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":0F20
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":12BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":1654
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":19EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":1D88
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":2122
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":24BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantUM.frx":317E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraListado 
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gLista 
         Height          =   5880
         Left            =   135
         OleObjectBlob   =   "frmMantUM.frx":3534
         TabIndex        =   1
         Top             =   960
         Width           =   8085
      End
   ...
   Begin VB.Frame fraGeneral 
      ...
      Top             =   600
      Width           =   8325
      Begin CATControls.CATTextBox txtCod_UM 
         Height          =   315
         Left            =   7095
         TabIndex        =   5
         Tag             =   "TidUM"
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantUM.frx":50CF
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_UM 
         Height          =   315
         Left            =   1365
         TabIndex        =   2
         Tag             =   "TglsUM"
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantUM.frx":50EB
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txt_abreUM 
         Height          =   315
         Left            =   1365
         TabIndex        =   3
         Tag             =   "TabreUM"
...
Dim strMsg      As String
    ...
    validaHomonimia "unidadmedida", "GlsUM", "idUM", txtGls_UM.Text, txtCod_UM.Text, False, StrMsgError, "or abreUM = '" & txt_abreUM.Text & "'"
    If StrMsgError <> "" Then GoTo Err
    
    If txtCod_UM.Text = "" Then
        txtCod_UM.Text = GeneraCorrelativoAnoMes("unidadmedida", "idUM", False)
        EjecutaSQLForm Me, 0, False, "unidadmedida", StrMsgError
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Grabó"
    
    Else
        EjecutaSQLForm Me, 1, False, "unidadmedida", StrMsgError, "idUM"
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Modificó"
    End If
...
Dim StrMsgError As String
    ...
    mostrarUM gLista.Columns.ColumnByName("idUM").Value, StrMsgError
    If StrMsgError <> "" Then GoTo Err
...
Dim StrMsgError As String
    ...
    Select Case Button.Index
        ...
        Case 5 'Eliminar
            ...
            If StrMsgError <> "" Then GoTo Err
        Case 6 'Imprimir
            gLista.m.ExportToXLS App.Path & "\Temporales\Mantenimiento_UM.xls"
            ShellEx App.Path & "\Temporales\Mantenimiento_UM.xls", essSW_MAXIMIZE, , , "open", Me.hwnd
        Case 8 'Salir
            Unload Me
    End Select
...
Private Sub listaUM(ByRef StrMsgError As String)
...
Dim strCond As String
    ...
    If Trim(txt_TextoBuscar.Text) <> "" Then
        ...
        strCond = " WHERE U.GlsUM LIKE '%" & strCond & "%' or U.abreUM LIKE '%" & strCond & "%'"
    End If
    
    csql = "SELECT U.idUM ,U.GlsUM,U.abreUM " & _
           "FROM unidadmedida U "
    If strCond <> "" Then csql = csql + strCond
    csql = csql & " ORDER BY U.idUM"
...
Private Sub mostrarUM(strCodUM As String, ByRef StrMsgError As String)
On Error GoTo Err
Dim rst As New ADODB.Recordset

    csql = "SELECT U.idUM,U.GlsUM,U.abreUM " & _
           "FROM unidadmedida U " & _
           "WHERE U.idUM = '" & strCodUM & "'"
...
Dim rsValida As New ADODB.Recordset
    ...
    strCodigo = Trim(txtCod_UM.Text)
    
    csql = "SELECT idProducto FROM productos WHERE idUMCompra = '" & strCodigo & "' OR idUMVenta = '" & strCodigo & "'"
    ...
    csql = "SELECT Item FROM presentaciones WHERE idUM = '" & strCodigo & "'"
    If rsValida.State = 1 Then rsValida.Close
    rsValida.Open csql, Cn, adOpenForwardOnly, adLockReadOnly
    If Not rsValida.EOF Then
        StrMsgError = "No se puede eliminar el registro, el registro se encuentra en uso (Presentaciones)."
        GoTo Err
    End If
    
    csql = "SELECT IdUM FROM preciosventa WHERE idUM = '" & strCodigo & "'"
    If rsValida.State = 1 Then rsValida.Close
    rsValida.Open csql, Cn, adOpenForwardOnly, adLockReadOnly
    If Not rsValida.EOF Then
        StrMsgError = "No se puede eliminar el registro, el registro se encuentra en uso (Lista de Precios)."
        GoTo Err
    End If
    ...
    '--- Eliminando presentaciones
    csql = "DELETE FROM presentaciones WHERE idUM = '" & strCodigo & "'"
    Cn.Execute csql
    
    '--- Eliminando de la Lista de Precios
    csql = "DELETE FROM preciosventa WHERE idUM = '" & strCodigo & "'"
    Cn.Execute csql
    
    '--- Eliminando el registro
    csql = "DELETE FROM unidadmedida WHERE idUM = '" & strCodigo & "'"
    Cn.Execute csql
