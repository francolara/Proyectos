...
Begin VB.Form frmMantPersona 
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "frmMantPersona.frx":0000
   ScaleHeight     =   9435
   ScaleWidth      =   11250
   Begin MSComctlLib.ImageList imgDocVentas 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":0342
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":06DC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":0B2E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":0EC8
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":1262
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":15FC
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":1996
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":1D30
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":20CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":2464
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":27FE
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantPersona.frx":34C0
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraListado 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin CATControls.CATTextBox txt_TextoBuscar 
            ...
            MaxLength       =   255
            Container       =   "frmMantPersona.frx":385A
            Estilo          =   1
            Vacio           =   -1  'True
            EnterTab        =   -1  'True
         End
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gLista 
         Height          =   7605
         Left            =   135
         OleObjectBlob   =   "frmMantPersona.frx":3876
         TabIndex        =   1
         Top             =   1020
         Width           =   10920
      End
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin VB.CommandButton CmbTipoDocIdentidad 
         ...
         Height          =   315
         Left            =   10515
         Picture         =   "frmMantPersona.frx":6DB4
         Style           =   1  'Graphical
         TabIndex        =   51
         Top             =   4185
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaDistrito 
         ...
         Height          =   315
         Left            =   10515
         Picture         =   "frmMantPersona.frx":713E
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   3420
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaProv 
         ...
         Height          =   315
         Left            =   10515
         Picture         =   "frmMantPersona.frx":74C8
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   3045
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaDepa 
         ...
         Height          =   315
         Left            =   10515
         Picture         =   "frmMantPersona.frx":7852
         Style           =   1  'Graphical
         TabIndex        =   37
         Top             =   2670
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaPais 
         ...
         Height          =   315
         Left            =   10515
         Picture         =   "frmMantPersona.frx":7BDC
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   2295
         Width           =   390
      ...
      Begin VB.CommandButton cmbAyudaTipoPersona 
         ...
         Height          =   315
         Left            =   10515
         Picture         =   "frmMantPersona.frx":7F66
         Style           =   1  'Graphical
         TabIndex        =   33
         Top             =   720
         Width           =   390
      ...
      Begin CATControls.CATTextBox txtCod_Persona 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":82F0
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Paterno 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   80
         Container       =   "frmMantPersona.frx":830C
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Materno 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   80
         Container       =   "frmMantPersona.frx":8328
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Nombres 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   80
         Container       =   "frmMantPersona.frx":8344
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Direccion 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantPersona.frx":8360
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txt_RUC 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   11
         Container       =   "frmMantPersona.frx":837C
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txt_Telefono 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   85
         Container       =   "frmMantPersona.frx":8398
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txt_Email 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   80
         Container       =   "frmMantPersona.frx":83B4
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtCod_TipoPersona 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantPersona.frx":83D0
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_TipoPersona 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":83EC
      End
      Begin CATControls.CATTextBox txtCod_Pais 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantPersona.frx":8408
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Pais 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":8424
      End
      Begin CATControls.CATTextBox txtCod_Depa 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantPersona.frx":8440
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Depa 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":845C
      End
      Begin CATControls.CATTextBox txtCod_Prov 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantPersona.frx":8478
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Prov 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":8494
      End
      Begin CATControls.CATTextBox txtCod_Distrito 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantPersona.frx":84B0
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Distrito 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":84CC
      End
      Begin CATControls.CATTextBox txtGlsPersona 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":84E8
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_DireccionFiscal 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantPersona.frx":8504
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Contacto 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantPersona.frx":8520
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox TxtCodTipoDocIdentidad 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantPersona.frx":853C
         Estilo          =   1
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox TxtGlsTipoDocIdentidad 
         ...
         FontSize        =   8.25
         ForeColor       =   -2147483640
         Container       =   "frmMantPersona.frx":8558
      End
      Begin CATControls.CATTextBox TxtGlsNombreComercial 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   80
         Container       =   "frmMantPersona.frx":8574
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
   ...
   End
End
Attribute VB_Name = "frmMantPersona"
...
Dim StrMsgError As String
    ...
    Select Case Button.Index
        ...
        Case 5 'Eliminar
            ...
            If StrMsgError <> "" Then GoTo Err
        Case 6 'Imprimir
            gLista.m.ExportToXLS App.Path & "\Temporales\Mantenimiento_Entidades.xls"
            ShellEx App.Path & "\Temporales\Mantenimiento_Entidades.xls", essSW_MAXIMIZE, , , "open", Me.hwnd
        Case 8 'Salir
            Unload Me
    End Select
...
Dim rsdatos                     As New ADODB.Recordset
    ...
    CSqlC = "Select IdPersona,GlsPersona,case when TipoPersona = '01001' then 'Natural' else 'Juridica' end TipoPersona,Ruc," & _
            "(Direccion + ', ' + isnull(U.GlsUbigeo, '')) Direccion,GlsNombreComercial,CASE WHEN isnull(B.IdProveedor,'') <> '' THEN '1' ELSE '0' END IndProveedor," & _
            "CASE WHEN isnull(C.IdCliente,'') <> '' THEN '1' ELSE '0' END IndCliente " & _
            "From Personas P " & _
    ...
    If chk_Cliente.Value Then
        If traerCampo("clientes", "idCliente", "idCliente", txtCod_Persona.Text, True) = "" Then
           ...
           Cn.Execute csql
            ...
            csql = "Insert Into TiendasCliente(idEmpresa, idPersona, item, GlsNombre, GlsDireccion, GlsTelefonos, GlsContacto, iddistrito, idVendedor, idPais, idtdacli ) values " & _
                    "('" & glsEmpresa & "','" & txtCod_Persona.Text & "',1,'PRINCIPAL','" & Me.txtGls_Direccion.Text & "','" & Me.txt_Telefono.Text & "','" & Me.txtgls_contacto.Text & "','" & Me.txtCod_Distrito.Text & "','','" & Me.txtCod_Pais.Text & "','" & glsEmpresa & Me.txtCod_Persona.Text & "1" & "') "
           Cn.Execute csql
        End If
    End If
