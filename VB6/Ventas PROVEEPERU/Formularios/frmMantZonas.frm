...
Begin VB.Form frmMantZonas 
   ...
   Begin MSComctlLib.ImageList imgDocVentas 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":039A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":07EC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":0B86
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":0F20
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":12BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":1654
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":19EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":1D88
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":2122
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":24BC
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMantZonas.frx":317E
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame fraListado 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin CATControls.CATTextBox txt_TextoBuscar 
            ...
            MaxLength       =   255
            Container       =   "frmMantZonas.frx":3518
            Estilo          =   1
            Vacio           =   -1  'True
            EnterTab        =   -1  'True
         End
      ...
      Begin DXDBGRIDLibCtl.dxDBGrid gLista 
         Height          =   3855
         Left            =   120
         OleObjectBlob   =   "frmMantZonas.frx":3534
         TabIndex        =   1
         Top             =   960
         Width           =   7995
      End
   ...
   Begin VB.Frame fraGeneral 
      ...
      Begin CATControls.CATTextBox txtCod_Zona 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   8
         Container       =   "frmMantZonas.frx":4C3C
         Estilo          =   1
         Vacio           =   -1  'True
         EnterTab        =   -1  'True
      End
      Begin CATControls.CATTextBox txtGls_Zona 
         ...
         ForeColor       =   -2147483640
         MaxLength       =   255
         Container       =   "frmMantZonas.frx":4C58
         Estilo          =   1
         EnterTab        =   -1  'True
      End
...
Dim strMsg      As String
    ...
    validaHomonimia "zonas", "GlsZona", "idZona", txtGls_Zona.Text, txtCod_Zona.Text, False, StrMsgError
    If StrMsgError <> "" Then GoTo Err
    
    If txtCod_Zona.Text = "" Then 'graba
        txtCod_Zona.Text = GeneraCorrelativoAnoMes("zonas", "idZona", False)
        EjecutaSQLForm Me, 0, False, "zonas", StrMsgError
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Grabo"
    
    Else 'modifica
        EjecutaSQLForm Me, 1, False, "zonas", StrMsgError, "idZona"
        If StrMsgError <> "" Then GoTo Err
        strMsg = "Modifico"
    End If
...
Dim StrMsgError As String
    ...
    mostrarZonas gLista.Columns.ColumnByName("idZona").Value, StrMsgError
    If StrMsgError <> "" Then GoTo Err
...
Private Sub listaZonas(ByRef StrMsgError As String)
On Error GoTo Err
...
Dim rsdatos                     As New ADODB.Recordset
    ...
    If Trim(txt_TextoBuscar.Text) <> "" Then
        ...
        strCond = " WHERE a.GlsZona LIKE '%" & strCond & "%'"
    End If
    
    csql = "SELECT a.idZona ,a.GlsZona " & _
           "FROM zonas a "
    If strCond <> "" Then csql = csql & strCond
    csql = csql & " ORDER BY a.idZona"
...
Private Sub mostrarZonas(strCod As String, ByRef StrMsgError As String)
On Error GoTo Err
Dim rst As New ADODB.Recordset

    csql = "SELECT a.idZona,a.GlsZona " & _
           "FROM zonas a " & _
           "WHERE a.idZona = '" & strCod & "'"
...
Dim rsValida As New ADODB.Recordset
    ...
    strCodigo = Trim(txtCod_Zona.Text)
    
    Cn.BeginTrans
    indTrans = True
    
    '--- Eliminando el registro
    csql = "DELETE FROM zonas WHERE idZona = '" & strCodigo & "'"
    Cn.Execute csql
