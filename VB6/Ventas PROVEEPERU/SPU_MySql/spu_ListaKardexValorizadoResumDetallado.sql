...
DROP PROCEDURE IF EXISTS `spu_ListaKardexValorizadoResumDetallado` $$
CREATE  PROCEDURE `spu_ListaKardexValorizadoResumDetallado`(
varEmpresa      CHAR(2),
...
END IF;
  ...
  pr.CtaContable2,n.idnivel,n.glsNivel,um.abreUM, pe.GlsPersona,pr.IdProducto,pr.GlsProducto,
...
--  Group By vn.idNivel02
  group by n.idnivel,pr.idProducto
  Order by n.GlsNivel,pr.IdProducto ;
