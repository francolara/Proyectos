...
Dim rst As New ADODB.Recordset
    ...
    Do While Not rst.EOF
        Select Case UCase(rst.Fields("GlsParametro"))
            Case "IGV": glsIGV = Val(rst.Fields("ValParametro")) / 100: STR_IGV = Trim(rst.Fields("ValParametro") & "")
            ...
            Case "SUCURSAL_PARTIDA_UBIGEO":  STR_SUCURSAL_PARTIDA_UBIGEO = Trim(rst.Fields("ValParametro") & "")
            Case "SUCURSAL_PARTIDA_DIRECCION":  STR_SUCURSAL_PARTIDA_DIRECCION = Trim(rst.Fields("ValParametro") & "")
...
Public Function DataProcedimiento_Rpt(ByVal lstrNombreSP As String, ByRef StrMsgError As String, ByRef StrParametros As String) As ADODB.Recordset
...
arrValParam = Split(StrParametros, "|")

60    parametros = ""

70    For intI = 0 To UBound(arrValParam)
          If parametros = "" Then
            parametros = "'" & arrValParam(intI) & "'"
          Else
            parametros = parametros & ",'" & arrValParam(intI) & "'"
          End If
90    Next
...
100   Set DataProcedimiento_Rpt = rsdatos
