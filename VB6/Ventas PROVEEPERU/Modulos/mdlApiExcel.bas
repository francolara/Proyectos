...
Public Function fpUsuarioActual() As String
...
Dim sUsuario As String
    ...
    Else
        sUsuario = ""
    End If
    fpUsuarioActual = sUsuario

End Function

Public Function fpComputerName() As String
...
Dim ComputerNameLength As Long
    ...
    fpComputerName = Mid(sComputerName, 1, ComputerNameLength)
