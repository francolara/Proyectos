    ...
    If Not rst.EOF Then
        For i = 0 To rst.Fields.Count - 1
            ...
            ElseIf rst.Fields(i).Name = "Partida" Then
                ...
                '--- Se está utilizando el campo vehicuo para imprimir la fecha del documento de referencia  de NC para ITS
                ...
                ElseIf rst.Fields(i).Name = "ObsDocVentas" Or rst.Fields(i).Name = "ObsDocVentas2" Then
